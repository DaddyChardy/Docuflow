    ...
    return (
        <div className="p-8">
            <header className="mb-8">
                <h1 className="text-3xl font-serif italic text-blue-900 mb-2">Document Archives</h1>
                <p className="text-gray-600">Browse and reference documents from previous academic years.</p>
            </header>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
                ...
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-900 outline-none"
                    />
                </div>
                ...
                {isSuperAdmin && (
                    <div className="w-full md:w-64 relative">
                        ...
                        <select
                            ...
                            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-900 outline-none appearance-none bg-white font-medium text-blue-900"
                        >
                ...
                <div className="w-full md:w-64 relative">
                    ...
                    <select
                        ...
                        className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-900 outline-none appearance-none bg-white"
                    >
            ...
            {loading && years.length > 0 ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                    ...
                    <p className="text-gray-500">No documents found for this year.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredDocs.map((doc: any) => (
                        <div key={doc.id} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition group">
                            ...
                            <p className="text-xs text-blue-600 font-medium mb-1">{doc.type}</p>
                            ...
                            <button
                                ...
                                className="w-full py-2 border border-blue-900 text-blue-900 rounded-lg font-medium hover:bg-blue-900 hover:text-white transition flex items-center justify-center gap-2"
                            >
